...
def show
  render json: @form, include: 'questions' #renderiza o @form, que vem do set_form. se eu quiser renderizar json e quiser pegar alguma coisa associada ao forms, eu passo o include: "question" no caso.
end
